...
"[project]/Reactjs/Celu/project-bolt-sb1-r7qsskrc/funcional/project/app/api/admin/usuarios/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const { data: rows, error } = await admin.from('profiles').select('id, email, full_name, whatsapp, role, status, created_at, updated_at, account_type, province, city').order('created_at', {
            ascending: false
        });
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__60fb4eaf._.js.map