...
;
;
function ConfirmDialog({ open, onOpenChange, title, description, confirmLabel = 'Eliminar', cancelLabel = 'Cancelar', onConfirm, destructive = true }) {
...
function SellerAdsList() {
    ...
    const handleConfirmDelete = async ()=>{
        ...
        if ("TURBOPACK compile-time truthy", 1) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Reactjs$2f$Celu$2f$project$2d$bolt$2d$sb1$2d$r7qsskrc$2f$funcional$2f$project$2f$lib$2f$repositories$2f$getAdsRepo$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAdsRepo"])().delete(adToDelete.id);
            await refreshAds();
    ...
    const setAdStatus = async (adId, status)=>{
        if ("TURBOPACK compile-time truthy", 1) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Reactjs$2f$Celu$2f$project$2d$bolt$2d$sb1$2d$r7qsskrc$2f$funcional$2f$project$2f$lib$2f$repositories$2f$getAdsRepo$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAdsRepo"])().update(adId, {
                status
            });
            await refreshAds();
        } else //TURBOPACK unreachable
...
//# sourceMappingURL=Reactjs_Celu_project-bolt-sb1-r7qsskrc_funcional_project_e5dc8588._.js.map