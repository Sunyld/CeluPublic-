...
"[project]/Reactjs/Celu/project-bolt-sb1-r7qsskrc/funcional/project/app/api/admin/solicitacoes/approve/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { error: reqErr } = await admin.from('seller_requests').update({
            status: 'approved',
            reviewed_by: user.id,
        ...
        console.log('[API/ADMIN/APPROVE] OK requestId:', requestId, 'userId:', userId);
        return __TURBOPACK__imported__module__$5b$project$5d2f$Reactjs$2f$Celu$2f$project$2d$bolt$2d$sb1$2d$r7qsskrc$2f$funcional$2f$project$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true,
            updated: {
                requestId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2c27ae97._.js.map