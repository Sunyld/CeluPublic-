...
"[project]/Reactjs/Celu/project-bolt-sb1-r7qsskrc/funcional/project/app/(site)/anuncios/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdListingPage() {
    ...
    const { ads, users, getCategoryById, categories } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Reactjs$2f$Celu$2f$project$2d$bolt$2d$sb1$2d$r7qsskrc$2f$funcional$2f$project$2f$context$2f$AppContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useApp"])();
    const category = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Reactjs$2f$Celu$2f$project$2d$bolt$2d$sb1$2d$r7qsskrc$2f$funcional$2f$project$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdListingPage.useMemo[category]": ()=>categoryId ? getCategoryById(categoryId) : null
    }["AdListingPage.useMemo[category]"], [
        categoryId,
        getCategoryById
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Reactjs$2f$Celu$2f$project$2d$bolt$2d$sb1$2d$r7qsskrc$2f$funcional$2f$project$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdListingPage.useEffect": ()=>{
            const t = setTimeout({
                "AdListingPage.useEffect.t": ()=>setLoading(false)
            }["AdListingPage.useEffect.t"], LOADING_DELAY_MS);
            return ({
                "AdListingPage.useEffect": ()=>clearTimeout(t)
            })["AdListingPage.useEffect"];
        }
    }["AdListingPage.useEffect"], []);
    const citiesInProvince = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Reactjs$2f$Celu$2f$project$2d$bolt$2d$sb1$2d$r7qsskrc$2f$funcional$2f$project$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdListingPage.useMemo[citiesInProvince]": ()=>province ? __TURBOPACK__imported__module__$5b$project$5d2f$Reactjs$2f$Celu$2f$project$2d$bolt$2d$sb1$2d$r7qsskrc$2f$funcional$2f$project$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CIDADES_POR_PROVINCIA"][province] ?? [] : []
    }["AdListingPage.useMemo[citiesInProvince]"], [
        province
    ]);
    const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Reactjs$2f$Celu$2f$project$2d$bolt$2d$sb1$2d$r7qsskrc$2f$funcional$2f$project$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdListingPage.useMemo[filtered]": ()=>{
            const allAds = categoryId ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$Reactjs$2f$Celu$2f$project$2d$bolt$2d$sb1$2d$r7qsskrc$2f$funcional$2f$project$2f$lib$2f$selectors$2f$adsSelectors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAdsByCategoryPublic"])(ads, users, categoryId) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$Reactjs$2f$Celu$2f$project$2d$bolt$2d$sb1$2d$r7qsskrc$2f$funcional$2f$project$2f$lib$2f$selectors$2f$adsSelectors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPublicAds"])(ads, users);
            let f = allAds;
            if (type) f = f.filter({
                "AdListingPage.useMemo[filtered]": (a)=>a.type === type
            }["AdListingPage.useMemo[filtered]"]);
            if (province) {
                const citiesSet = new Set(citiesInProvince);
                f = f.filter({
                    "AdListingPage.useMemo[filtered]": (a)=>citiesSet.has(a.location)
                }["AdListingPage.useMemo[filtered]"]);
            }
            if (city) f = f.filter({
                "AdListingPage.useMemo[filtered]": (a)=>a.location === city
            }["AdListingPage.useMemo[filtered]"]);
            return f;
        }
    }["AdListingPage.useMemo[filtered]"], [
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Reactjs$2f$Celu$2f$project$2d$bolt$2d$sb1$2d$r7qsskrc$2f$funcional$2f$project$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Reactjs$2f$Celu$2f$project$2d$bolt$2d$sb1$2d$r7qsskrc$2f$funcional$2f$project$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(AdListingPage, "kkk9+/GFIL1jnvyEj1QS6pk2g98=", false, function() {
    return [
...
_c = AdListingPage;
var _c;
__turbopack_context__.k.register(_c, "AdListingPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=Reactjs_Celu_project-bolt-sb1-r7qsskrc_funcional_project_480c084b._.js.map