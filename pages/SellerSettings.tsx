      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Nome e email não são editáveis. Pode actualizar WhatsApp e província.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 pt-4 border-t">
            ...
            <AppButton type="submit" disabled={submitting}>{saved ? 'Guardado' : submitting ? 'A guardar...' : 'Guardar alterações'}</AppButton>
          </form>
        </CardContent>
      </Card>
    </div>
